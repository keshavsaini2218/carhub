        ...
        <Dialog as="div" className="relative z-10 " onClose={closeModal}>
            ...
            <div className='fixed inset-0 overflow-y-auto'>
                <div className='flex min-h-full items-center justify-center p-4 text-center '>
                    <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo='opacity-100 scale-100' leave="ease-out duration-300" leaveFrom="opacity-100 scale-100" leaveTo='opacity-0 scale-95' >
